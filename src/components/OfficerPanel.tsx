...
export const OfficerPanel: React.FC<OfficerPanelProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Admin Header */}
      <section className="bg-gradient-to-br from-zinc-950 via-blue-950 to-indigo-950 text-white rounded-2xl p-5 shadow-lg border border-zinc-800">
        <div className="flex justify-between items-center gap-4">
          <div className="space-y-1">
            <span className="text-[10px] text-blue-300 font-extrabold uppercase tracking-widest flex items-center gap-1.5 block">
              <Shield className="w-3.5 h-3.5 fill-blue-500 text-blue-400 animate-pulse" />
          ...
          <BarChart className="w-10 h-10 text-blue-400 flex-shrink-0 opacity-80" />
        </div>
      </section>
      ...
      {activeTab === "analytics" && (
        <div className="space-y-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { icon: Users, label: "Total Students", value: totalMembersCount, sub: "SMC PolSci Enrollees", color: "text-blue-600 bg-blue-50 dark:bg-blue-950/20" },
              { icon: Sparkles, label: "Average Standing", value: `${avgExp} EXP`, sub: "App-wide member average", color: "text-amber-600 bg-amber-50 dark:bg-amber-950/20" },
              ...
              { icon: CheckCircle, label: "Grade Requests", value: gradeRequests.length, sub: "Pending officer review", color: "text-emerald-600 bg-emerald-50 dark:bg-emerald-950/20" }
            ].map((card, i) => (
        ...
        <form onSubmit={handlePostAnnouncement} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-2xl shadow-sm space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full text-sm p-3.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-blue-600 text-zinc-900 dark:text-zinc-100 font-semibold"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full text-sm p-3.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-blue-600 text-zinc-500 dark:text-zinc-400 font-semibold cursor-pointer"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full text-sm p-3.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-blue-600 text-zinc-900 dark:text-zinc-100 font-semibold cursor-pointer"
              >
      ...
      {activeTab === "badge" && (
        <form onSubmit={handleAwardBadgeSubmit} className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-2xl shadow-sm space-y-4">
          ...
          <button
            ...
            className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-xs font-extrabold shadow flex items-center justify-center gap-2 cursor-pointer transition-transform hover:-translate-y-0.5 disabled:opacity-40 disabled:cursor-not-allowed"
          >
                  ...
                  <div key={m.studentId} className="bg-white dark:bg-zinc-900 p-4 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-sm space-y-3">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-[10px] font-black cursor-pointer shadow-sm"
                      >
                        Approve Conversion
                      </button>
                      <button
                        ...
                        {activeGrievanceIdForResolution === g.id ? (
                          <div className="space-y-2">
                            <textarea
                              ...
                              className="w-full text-xs p-2.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg outline-none text-zinc-900 dark:text-zinc-100"
                            />
                            <div className="flex gap-2">
                              <button
                                onClick={() => handleResolveGrievance(g.id)}
                                className="px-3.5 py-1.5 bg-blue-600 text-white rounded-lg text-[10px] font-black cursor-pointer shadow-sm"
                              >
                                Submit Resolution
                              </button>
                              <button
                          ...
                          <div className="flex gap-1.5">
                            <button
                              ...
                              className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-[10px] font-black cursor-pointer disabled:opacity-40"
                            >
                              In Progress
                            </button>
                            <button
