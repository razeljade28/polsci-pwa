      ...
      <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm">
        <div className="flex justify-between items-center gap-4">
          <div className="space-y-1">
            <span className="text-[10px] text-blue-600 dark:text-blue-400 font-extrabold uppercase tracking-widest block">SMC PolSci Calendar</span>
          ...
          <Calendar className="w-10 h-10 text-blue-600 flex-shrink-0 opacity-80" />
        </div>
      </section>
      ...
      <div className="flex border-b border-zinc-200 dark:border-zinc-800 gap-4">
        <button
          ...
          className={`pb-2.5 text-sm font-extrabold tracking-wide transition-colors relative cursor-pointer ${
            activeTab === "all" ? "text-blue-600 dark:text-blue-400" : "text-zinc-400 hover:text-zinc-500 dark:text-zinc-500 dark:hover:text-zinc-400"
          }`}
        >
          All Events
          {activeTab === "all" && (
            <span className="absolute bottom-0 left-0 right-0 h-0.5 bg-blue-600 dark:bg-blue-400 rounded" />
          )}
        </button>
        <button
          onClick={() => setActiveTab("schedule")}
          className={`pb-2.5 text-sm font-extrabold tracking-wide transition-colors relative cursor-pointer ${
            activeTab === "schedule" ? "text-blue-600 dark:text-blue-400" : "text-zinc-400 hover:text-zinc-500 dark:text-zinc-500 dark:hover:text-zinc-400"
          }`}
        >
          ...
          filteredEvents.map(event => {
            ...
            return (
              ...
              >
                ...
                <div className={`h-2 ${
                  isPast ? "bg-zinc-400 dark:bg-zinc-600" : "bg-gradient-to-r from-blue-600 to-indigo-600"
                }`} />
                ...
                <div className="p-5 flex-1 space-y-4">
                  <div className="flex justify-between items-start gap-4">
                    ...
                    <span className={`text-xs font-bold ${isPast ? "text-zinc-400" : "text-blue-600 dark:text-blue-400"}`}>
                ...
                <div className="bg-zinc-50 dark:bg-zinc-950 p-4 border-t border-zinc-100 dark:border-zinc-800 flex flex-wrap gap-2 items-center justify-between">
                  <span className="inline-flex items-center gap-1.5 bg-blue-50 dark:bg-blue-950/20 text-blue-800 dark:text-blue-300 font-extrabold text-xs px-3 py-1.5 rounded-full border border-blue-100/40">
                  ...
                  <div className="flex gap-2">
                    ...
                    {!isPast && (
                      <button
                        ...
                        className="p-2 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:border-blue-600 bg-white dark:bg-zinc-900 cursor-pointer text-zinc-500 dark:text-zinc-400"
                      >
                    ...
                    {!isPast ? (
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-xs font-bold shadow-sm transition-all flex items-center gap-1.5 cursor-pointer ${
                          attended
                            ? "bg-blue-50/50 dark:bg-blue-950/10 border border-blue-100 dark:border-blue-900/20 text-blue-700 dark:text-blue-400 cursor-not-allowed"
            ...
            <form onSubmit={handleFeedbackSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full text-sm p-3.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600/10 text-zinc-900 dark:text-zinc-100"
                />
              </div>
