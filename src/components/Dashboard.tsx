  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="col-span-1 md:col-span-3 relative overflow-hidden rounded-2xl p-6 text-white bg-gradient-to-br from-blue-700 via-indigo-600 to-blue-800 shadow-md border border-blue-500/20 flex flex-col justify-between group">
          {/* Decorative Elements */}
          <div className="absolute right-0 top-0 w-48 h-48 bg-gradient-to-br from-yellow-300/10 to-transparent rounded-full filter blur-xl pointer-events-none" />
          <div className="absolute -right-20 -bottom-20 w-48 h-48 border-[24px] border-yellow-500/10 rounded-full pointer-events-none" />

          <div className="relative z-10 flex flex-col md:flex-row justify-between gap-6">
            <div className="flex-1 space-y-2">
              <div className="flex items-center gap-2">
                <span className="text-[9px] uppercase font-bold tracking-widest text-blue-100 bg-white/10 px-2.5 py-0.5 rounded-full border border-white/10">
              ...
              <p className="text-xs text-blue-50/90 max-w-md font-medium leading-relaxed">
            ...
            <div className="flex-shrink-0 flex items-center md:justify-center gap-4 bg-white/10 backdrop-blur-md border border-white/20 px-5 py-4 rounded-xl shadow-inner md:w-36 text-center">
              <div className="space-y-0.5 flex-1 md:flex-none">
                ...
                <strong className="text-3xl font-extrabold block text-yellow-300">{level.level}</strong>
          ...
          <div className="relative z-10 mt-6 pt-4 border-t border-white/10">
            <div className="flex justify-between items-center text-xs font-bold text-blue-100">
              ...
              {nextLevel ? (
                ...
                <span className="text-yellow-300">🏆 Max Level Reached!</span>
              )}
            </div>
            <div className="h-2 bg-white/20 rounded-full mt-2 overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-yellow-300 to-amber-400 rounded-full transition-all duration-1000 shadow-sm"
        ...
        <div className="col-span-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div>
            <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider block mb-3">Quick Navigation</span>
            <h4 className="text-sm font-extrabold text-zinc-900 dark:text-zinc-100 leading-none mb-4 flex items-center gap-1.5 font-display">
              <Sparkles className="w-4 h-4 text-yellow-500 animate-pulse" /> Shortcuts
            </h4>
          </div>
          <div className="grid grid-cols-2 gap-2 my-auto">
            {[
              ...
              <button
                ...
                className="flex flex-col items-center gap-1.5 p-2 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 hover:border-blue-600 active:scale-95 transition-all text-center cursor-pointer"
              >
                <div className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-950/15 flex items-center justify-center text-blue-600 dark:text-blue-400">
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <div>
              <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider block">Daily Study Check-in</span>
              ...
              <button
                ...
                className={`w-full border p-3 rounded-xl flex items-center justify-between text-left transition-all ${
                  q.completed
                    ...
                    : "bg-zinc-50 dark:bg-zinc-950 border-zinc-200 dark:border-zinc-800 hover:border-blue-600"
                }`}
              >
                <div className="flex items-center gap-3">
                  <span className={`w-4 h-4 rounded-full flex items-center justify-center font-bold text-[10px] ${
                    q.completed ? "bg-blue-600 text-white" : "border border-zinc-400 text-transparent"
                  }`}>
                    ✓
                  </span>
                  <div>
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div>
            <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider block">Featured Event</span>
            <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mt-1 font-display">
          ...
          <div className="my-3">
            {featuredEvent ? (
              <button
                ...
                className="w-full text-left text-white p-4 rounded-xl flex items-center gap-4 transition-all duration-300 bg-gradient-to-br from-amber-600 to-yellow-500 hover:from-amber-700 hover:to-yellow-600 shadow-sm"
              >
                <div className="w-12 h-12 bg-white text-zinc-900 rounded-lg flex flex-col justify-center items-center shadow-sm font-extrabold flex-shrink-0">
                  <strong className="text-lg leading-none">{dateLabel.day}</strong>
                  <small className="text-[9px] uppercase font-black text-amber-700 mt-0.5 leading-none">{dateLabel.month}</small>
                </div>
              ...
              <div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-dashed border-zinc-200 dark:border-zinc-800 rounded-xl text-center">
                ...
                <button
                  onClick={() => onNavigate("events")}
                  className="text-[10px] font-bold text-blue-600 mt-1 hover:underline"
                >
                  Browse event list
                </button>
              </div>
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div className="mb-4">
            <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider block">Official Broadcasts</span>
            <h3 className="text-sm font-extrabold text-zinc-900 dark:text-zinc-100 mt-1 flex items-center gap-2 font-display">
              <Megaphone className="w-4 h-4" /> Announcements & Bulletins
            </h3>
          </div>
            ...
            {announcements.length === 0 ? (
              ...
              announcements.slice(0, 2).map((a) => (
                <div key={a.id} className="flex gap-3 items-start bg-zinc-50 dark:bg-zinc-950/40 p-3 rounded-xl border border-zinc-100 dark:border-zinc-800/60">
                  <div className="w-7 h-7 rounded-lg bg-blue-50 dark:bg-blue-950/10 flex items-center justify-center text-blue-600 dark:text-blue-400 flex-shrink-0">
        ...
        <div className="col-span-1 md:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <div>
              <span className="text-[10px] text-blue-600 dark:text-blue-400 font-bold uppercase tracking-wider block">Top Standings</span>
              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between p-2.5 rounded-xl border transition-all ${
                    isYou
                      ? "bg-blue-50/30 dark:bg-blue-950/15 border-blue-500/20"
                ...
                >
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <strong className="text-xs font-extrabold block text-zinc-800 dark:text-zinc-200">
                        {m.name} {isYou && <small className="text-[9px] font-bold text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-950/30 px-1 rounded ml-1">(You)</small>}
                      </strong>
                  ...
                  <span className="text-xs font-extrabold text-blue-600 dark:text-blue-400">{m.exp} EXP</span>
                </div>
              );
            })}
          </div>
