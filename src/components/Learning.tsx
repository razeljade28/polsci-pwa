      ...
      <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm">
        <div className="flex justify-between items-center gap-4">
          <div className="space-y-1">
            <span className="text-[10px] text-primary-green dark:text-light-green font-extrabold uppercase tracking-widest block">POLSCI STUDY SPACE</span>
          ...
          <BookOpen className="w-10 h-10 text-primary-green dark:text-light-green flex-shrink-0 opacity-80" />
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
              ...
              return (
                <button
                  ...
                  className={`w-full p-3.5 border rounded-xl flex items-center justify-between text-left transition-all cursor-pointer ${
                    isSelected
                      ? "bg-primary-green/10 dark:bg-primary-green/20 border-primary-green dark:border-primary-green/50 shadow-sm"
                      : "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 hover:border-primary-green"
                  }`}
                >
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    {isPassed && (
                      <span className="text-[10px] font-black text-primary-green dark:text-light-green bg-primary-green/10 dark:bg-primary-green/20 px-1.5 py-0.5 rounded uppercase">
                        Passed
                      </span>
                    )}
          ...
          <div className="hidden lg:block">
            <h4 className="text-xs font-extrabold uppercase tracking-wider text-primary-green dark:text-light-green mb-3 px-1 flex items-center gap-1.5">
              <Sparkles className="w-4 h-4 text-gold-start" /> Need Instant Help?
            </h4>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-sm space-y-6">
            ...
            <div className="flex items-start justify-between gap-4 border-b border-zinc-200 dark:border-zinc-800 pb-4">
              <div>
                <span className="text-[10px] text-primary-green dark:text-light-green font-extrabold uppercase tracking-widest block">
              ...
              <button
                ...
                className={`flex items-center gap-1.5 border border-zinc-200 dark:border-zinc-800 px-3.5 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
                  learningProgress.saved.includes(activeTopic.id)
                    ...
                    : "bg-white dark:bg-zinc-950 text-zinc-500 hover:border-primary-green"
                }`}
              >
                {learningProgress.saved.includes(activeTopic.id) ? (
                  <>
            ...
            {/* Key Takeaway box */}
            <div className="bg-primary-green/10 dark:bg-primary-green/20 p-4 rounded-xl border border-primary-green/10 dark:border-primary-green/20 flex gap-3">
              <span className="text-xl">💡</span>
              <div className="space-y-1">
                <strong className="text-xs font-black uppercase text-primary-green dark:text-light-green tracking-wider">Key Takeaway</strong>
            ...
            <details className="group border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden [&_summary::-webkit-details-marker]:hidden bg-zinc-50 dark:bg-zinc-950" open>
              <summary className="flex justify-between items-center p-4 cursor-pointer focus:outline-none select-none font-bold text-sm text-zinc-900 dark:text-zinc-100">
                ...
                <span className="text-xs font-bold text-primary-green dark:text-light-green group-open:rotate-180 transition-transform">
                  ▼
                </span>
              </summary>
            ...
            {quizzes[activeTopic.id] ? (
              <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 bg-zinc-50 dark:bg-zinc-950 space-y-4">
                <div className="flex items-center gap-2 border-b border-zinc-200 dark:border-zinc-800 pb-2">
                  <HelpCircle className="w-4.5 h-4.5 text-primary-green" />
                  <span className="text-[10px] text-primary-green dark:text-light-green font-extrabold uppercase tracking-widest flex items-center gap-1.5">
                    POLSCI 101 Practice Quiz · <Award className="w-3.5 h-3.5 fill-gold-start text-gold-start" /> +20 EXP
                  </span>
                </div>
                      ...
                      return (
                        <button
                          ...
                          className={`w-full p-3.5 rounded-lg text-xs font-bold text-left border transition-all cursor-pointer ${
                            isOptionSelected
                              ? "bg-primary-green text-white border-primary-green shadow-sm"
                              : "bg-white dark:bg-zinc-900 border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-300 hover:border-primary-green"
                          }`}
                        >
                          {option}
                        </button>
                  ...
                  {quizFeedback && (
                    <div className={`p-3.5 rounded-lg text-xs border ${
                      quizFeedback.isCorrect
                        ? "bg-primary-green/10 dark:bg-primary-green/20 text-primary-green dark:text-light-green border-primary-green/20"
            ...
            {activeTopic.id === "reviewer" && (
              <button
                ...
                className="w-full py-3.5 bg-primary-green hover:bg-light-green text-white rounded-xl text-xs font-extrabold shadow-md flex items-center justify-center gap-2 cursor-pointer transition-all hover:-translate-y-0.5 duration-200"
              >
