    ...
    <div className="space-y-6">
      ...
      <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm">
        <div className="flex justify-between items-center gap-4">
          <div className="space-y-1">
            <span className="text-[10px] text-primary-green dark:text-light-green font-extrabold uppercase tracking-widest block">Confidential Reporting</span>
          ...
          <AlertTriangle className="w-10 h-10 text-primary-green dark:text-light-green flex-shrink-0 opacity-80" />
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-5 rounded-2xl shadow-sm space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full text-sm p-3.5 bg-zinc-50 dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-primary-green focus:ring-1 focus:ring-primary-green/10 text-zinc-900 dark:text-zinc-100 font-semibold"
              />
            </div>
            ...
            <label className="flex items-center gap-2.5 p-3 rounded-xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800/50 cursor-pointer select-none">
              <input
                ...
                className="w-4 h-4 text-primary-green rounded outline-none focus:ring-0 cursor-pointer"
              />
          ...
          {isSubmitted && (
            <div className="bg-primary-green/10 dark:bg-primary-green/20 text-primary-green dark:text-light-green p-3 rounded-xl border border-primary-green/20 flex items-center gap-2 text-xs font-semibold animate-pulse">
            ...
            <div className="space-y-4">
              {myGrievances.map((g) => {
                const statusColors = {
                  ...
                  "in-progress": "bg-primary-green/10 text-primary-green dark:bg-primary-green/20 dark:text-light-green border-primary-green/20",
                ...
                return (
                  ...
                  >
                    ...
                    {g.anonymous && (
                      <p className="text-[10px] text-primary-green dark:text-light-green font-bold">🔒 Submitted under Anonymous security</p>
                    )}
                    ...
                    {g.notes && g.status === "in-progress" && (
                      <div className="bg-primary-green/10 dark:bg-primary-green/20 p-3.5 rounded-xl border border-primary-green/20 flex gap-2.5 mt-2.5">
                        <Clock className="w-4.5 h-4.5 text-primary-green flex-shrink-0 animate-pulse" />
                        <div className="space-y-0.5">
                          <strong className="text-xs font-black uppercase tracking-wider text-primary-green dark:text-light-green">Officer Advisory Update</strong>
                          <p className="text-xs text-zinc-600 dark:text-zinc-300 font-medium">
                            {g.notes}
                          </p>
                        </div>
