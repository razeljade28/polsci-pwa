      ...
      <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-5 shadow-sm">
        <div className="flex justify-between items-center gap-4">
          <div className="space-y-1">
            <span className="text-[10px] text-primary-green dark:text-light-green font-extrabold uppercase tracking-widest block">SMC Careers Board</span>
          ...
          <Compass className="w-10 h-10 text-primary-green dark:text-light-green flex-shrink-0 opacity-80" />
        </div>
      </section>
            ...
            >
              <div className="space-y-3 flex-1">
                ...
                <div className="space-y-1">
                  ...
                  <strong className="text-xs font-bold text-primary-green dark:text-light-green block">{opp.organization}</strong>
                </div>
              ...
              <button
                ...
                className={`w-full sm:w-auto px-4 py-3 border rounded-xl text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
                  isSaved
                    ? "bg-primary-green text-white border-primary-green shadow"
