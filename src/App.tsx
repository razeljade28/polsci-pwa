  ...
  if (!currentUser) {
    return (
      <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col justify-center items-center px-4 py-12 transition-colors">
        ...
        <div className="absolute top-10 left-10 w-72 h-72 bg-primary-green/5 rounded-full filter blur-3xl pointer-events-none" />
        ...
        <div className="w-full max-w-md space-y-6 relative z-10">
          <div className="text-center space-y-3">
            <div className="w-20 h-20 bg-gradient-to-br from-dark-green to-primary-green rounded-2xl flex items-center justify-center text-4xl shadow-xl border border-light-green/30 mx-auto transform transition-transform hover:scale-105 duration-300">
              🏛️
            </div>
            <div>
              <h1 className="text-3xl font-extrabold tracking-tight bg-gradient-to-r from-primary-green to-gold-start bg-clip-text text-transparent font-display">
                SEPOLSCIS
              </h1>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full text-sm p-3.5 bg-zinc-50 dark:bg-zinc-950/40 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-primary-green text-zinc-900 dark:text-zinc-100 font-semibold"
                  />
                </div>
                ...
                {/* Preload info box */}
                <div className="p-3 bg-primary-green/10 dark:bg-primary-green/20 border border-primary-green/20 text-primary-green dark:text-light-green rounded-xl flex gap-2 text-[10px] font-semibold leading-relaxed">
                  <Info className="w-4 h-4 flex-shrink-0" />
                  <div>
                    <span className="font-extrabold block text-primary-green dark:text-light-green">Standard Study Accounts:</span>
                ...
                <button
                  type="submit"
                  className="w-full py-4 bg-primary-green hover:bg-light-green text-white rounded-xl text-xs font-extrabold tracking-wide uppercase shadow-md flex items-center justify-center gap-2 cursor-pointer transition-all hover:-translate-y-0.5 duration-200"
                >
                  Enter Portal Room
                </button>
              </form>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full text-sm p-3.5 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl outline-none focus:border-primary-green text-zinc-700 dark:text-zinc-300 font-semibold cursor-pointer"
                    >
    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors flex flex-col pb-24 md:pb-28">
      ...
      <header className="sticky top-0 z-50 bg-white/70 dark:bg-zinc-900/80 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 px-4 py-3 flex justify-between items-center max-w-7xl mx-auto w-full transition-colors">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 bg-primary-green text-white rounded-xl flex items-center justify-center font-black shadow-sm">
            🏛️
          </div>
          <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="w-10 h-10 border border-zinc-200 dark:border-zinc-800 rounded-xl flex items-center justify-center hover:border-primary-green bg-white dark:bg-zinc-900 cursor-pointer text-zinc-500 transition-all"
          >
          ...
          <button
            ...
            className={`flex flex-col items-center gap-1 py-1 px-3.5 rounded-2xl transition-all cursor-pointer ${
              currentScreen === item.id
                ? "bg-primary-green/10 dark:bg-primary-green/30 text-primary-green dark:text-light-green font-extrabold scale-105"
